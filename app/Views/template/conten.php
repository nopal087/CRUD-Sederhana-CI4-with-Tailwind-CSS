<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Menerima Pembuatan Website untuk Skripsi maupun Tugas</h1>
            <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Menerima pembuatan website static maupun dinamis dengan menggunakan bahasa pemrograman PHP, Laravel, CodeIgniter</p>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Desain yang menarik</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Desain yang dapat anda request sesuai dengan kebutuhan anda, anda dapat meminta menggunakan template yang sudah ada atau sesuai keinginan anda</p>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Penulisan kode yang rapih dan diberikan juga documentasi </h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Kami akan memberikan dokumentasi pada kode untuk memudahkan anda memahami isi dari kode yang kami kerjakan</p>
                <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg aria-hidden="true" class="w-4 h-4 ml-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
